...
\startThesisInfo
  ...
  \KeywordsCz{Navigace, Generování UI, Přístupnost, Windows Phone 8, UIProtocol}
  \KeywordsEn{Navigation, UI Generation, Accessibility, Windows Phone 8, UIProtocol}
...
\startBodyMatter
  \include{overallAnalysis}
  \include{uipAnalisys}
  \include{w8Acessibility}
  \include{androidAccessibility}
  \include{iphoneAcessibility}
