...
\documentclass[bcl]{felthesis} % or [...,czech] for thesis in Czech
...
\startBodyMatter
  \input{introduction}
  \input{overallAnalysis}
  \input{uipAnalysis}
  \input{w8Acessibility}
  \input{navigationSystems}
  \input{accessibilityGuidelines}
  \include{design}
